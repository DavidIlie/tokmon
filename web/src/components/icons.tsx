...
export const Refresh = (p: SVGProps<SVGSVGElement> & { className?: string }) => (
  <Icon {...p}><path d="M20 6v5h-5" /><path d="M4 18v-5h5" /><path d="M18.7 9A7 7 0 0 0 6.3 6.3L4 8" /><path d="M5.3 15A7 7 0 0 0 17.7 17.7L20 16" /></Icon>
)
